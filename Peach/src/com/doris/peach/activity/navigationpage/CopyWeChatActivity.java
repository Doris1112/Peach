...
import com.doris.peachlibrary.adapter.ViewPagerAdapter;
 ...
 *         2016年7月24日
 */
public class CopyWeChatActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_navigationpage_wechat);
	...
	private void startbutton() {  
		startActivity(new Intent(this, GuideViewDoorActivity.class));
		this.finish();
      }
