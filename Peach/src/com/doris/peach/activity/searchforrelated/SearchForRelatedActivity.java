 ...
 * 2016年5月12日
 */
public class SearchForRelatedActivity extends BaseActivity{
	...
	private void initList(){
		...
		list.add(getResources().getString(R.string.filmScreen));
		listener.add(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				startActivity(new Intent(context, FilmScreenActivity.class));
			}
		});
	}
}
